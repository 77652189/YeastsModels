...
$projectName = "YeastModels iMT1026 v3 FBA"
$port = 8504
$ruleName = "YeastModels iMT1026 Streamlit 8504 LAN"
$projectRoot = Resolve-Path (Join-Path $PSScriptRoot "..")
$appPath = "code/streamlit_iMT1026V3.py"
...
function Resolve-Python {
    $candidates = @(
        (Join-Path $projectRoot "..\.venv-cobrapy\Scripts\python.exe"),
